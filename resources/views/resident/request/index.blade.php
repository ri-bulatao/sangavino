            ...
            <div class="col-md-12">
                <div class="alert alert-dark alert-dismissible fade show p-3 text-white" role="alert">
                    ...
                    <p class="translated_text">
                        Note: On this page showcases the list of services you requested (Eg. Barangay Clearance, Certificate
                        of
                        Indigency, Certificate of Residency, etc.). To create a new
                        request (request a service), simply
                        click the
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="float-right btn btn-sm btn-success me-3"
                            href="{{ route('resident.requests.create') }}">Create
                            Request +</a><br><br>
