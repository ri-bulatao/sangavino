...
@section('title', 'Barangay Secretary | Create Request')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h2>
                            <a class="text-success mr-3" href="{{ route('secretary.requests.index') }}"><i
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <form action="{{ route('secretary.requests.store') }}" method="post">
                                    @csrf
